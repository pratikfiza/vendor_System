...
from vendor_management.views import VendorListCreateAPIView, VendorDetailAPIView, PurchaseOrderListCreateAPIView, PurchaseOrderRetrieveUpdateDestroyAPIView, VendorPerformanceAPIView


urlpatterns = [
    path('admin/', admin.site.urls),
    path('api/vendors/', VendorListCreateAPIView.as_view()),
    path('api/vendors/<int:pk>/', VendorDetailAPIView.as_view()),
